...
star_1.addEventListener("click",function(){
    ...
    ct6_fb.innerHTML = "Oh 1 sao, xin lỗi vì trải nghiệm không tốt, chúng tôi sẽ cố gắng phát triển hơn nữa !"
...
star_3.addEventListener("click",function(){
    ...
    star_2.classList.remove("ct6-hide")
    ct6_close.classList.remove("ct6-hide")
    ct6_fb.innerHTML = "2 sao, chúng tôi sẽ cố gắng hoàn thiện hơn nữa !"
